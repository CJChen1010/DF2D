"""
Defining DART-FISH codebooks compatible with StarFish's format. 
"""
...
barcode_file = '_codebook/HLK21_kidney_genes_barcodes.txt'
codebook_file = '_codebook/HLK2021_kidney_codebook.json'
create_jsoncodebook(infilepath=barcode_file, outfilepath=codebook_file,
                    totalCycles=7, offCycles=4, firstCycleAnchor=False,
                    addEmptyBarcodes=True, uniColorAllowed=False)
